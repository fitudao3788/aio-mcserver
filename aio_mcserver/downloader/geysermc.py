...
class GeyserMC(BaseDownloader):
    ...
    async def get_download_info(self) -> dict:
        ...
        return {
            "filename": f"Geyser-Spigot-{build_version}-{build["build"]}.jar",
            "url": f"https://download.geysermc.org/v2/projects/geyser/versions/{build_version}/builds/{build["build"]}/downloads/spigot",
